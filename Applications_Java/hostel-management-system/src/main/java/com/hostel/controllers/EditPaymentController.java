...
public class EditPaymentController {
    ...
    public void setPayment(Payment payment) {
        ...
        studentIdField.setText(String.valueOf(payment.getStudentId()));
        amountField.setText(String.valueOf(payment.getAmount()));
        dateField.setValue(LocalDate.parse(payment.getDate()));
    ...
    private void editPayment() {
        ...
        try {
            ...
            payment.setDate(date.format(DateTimeFormatter.ISO_DATE));
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Database Error", "An error occurred while updating payment: " + e.getMessage());
        }
    }
